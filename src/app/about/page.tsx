						...
						<div className="gh-bg-canvas-overlay border gh-border rounded-lg p-6">
							...
							<div className="space-y-4 gh-text-muted">
								<p>
									...
									solutions that make a difference. My journey in technology started several years
								...
								<p>
									...
									various databases. I enjoy working on both frontend and backend development, always
									striving to create seamless user experiences.
								</p>
								<p>
							...
							<div className="space-y-4">
								<div>
									...
									<div className="flex flex-wrap gap-2">
										{["React", "Next.js", "TypeScript", "Tailwind CSS", "HTML", "CSS"].map(
											(skill) => (
												<span
													key={skill}
