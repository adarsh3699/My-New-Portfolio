...
export const yourProjectNameData: Project = {
  ...
  longDescription: "Detailed description of your project. This will be used in the project detail page and README fallback.",
  
  // Custom sorting order (required) - lower numbers appear first
  index: 10,
    ...
    customSections: [
      {
        ...
        content: "Custom content for this section. You can add any additional information about your project here."
      },
      {
        title: "Another Section",
        icon: "📊",
        content: "Add as many custom sections as needed. Each section will appear with the specified icon and content."
      },
      {
        title: "Contributing",
        icon: "🤝",
        content: "Custom contributing guidelines for your project. Explain how others can contribute, coding standards, PR process, etc."
      },
      {
        title: "License",
        icon: "📄",
