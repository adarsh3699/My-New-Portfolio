...
export const myNewPortfolioData: Project = {
  ...
  description: "A modern, GitHub-inspired portfolio website built with Next.js 15, showcasing my projects, experience, and skills with a clean, professional design.",
  ...
  screenshots: [
    {
      ...
      description: "The main landing page showcasing a clean, GitHub-inspired design with modern typography and smooth animations. Features a hero section with personal introduction and quick navigation to key sections."
    },
    {
      url: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop",
      title: "Projects Showcase",
      description: "Interactive projects gallery with advanced filtering, search functionality, and detailed project cards. Each project displays technologies used, GitHub stats, and quick access to live demos."
    },
    {
      url: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=600&fit=crop",
      title: "Responsive Design",
      description: "Fully responsive layout that adapts beautifully to all screen sizes. Mobile-first approach ensures optimal user experience across desktop, tablet, and mobile devices."
    }
  ],
    ...
    customSections: [
      {
        title: "Architecture",
        icon: "🏗️",
        content: "Built using modern React patterns with TypeScript for type safety. The application follows a component-based architecture with reusable UI components and a clean separation of concerns."
      },
      {
        title: "SEO & Performance",
        icon: "⚡",
        content: "Optimized for search engines with proper meta tags, structured data, and server-side rendering. Achieves Lighthouse scores of 95+ with lazy loading, code splitting, and optimized assets."
      },
      {
        title: "Contributing",
        icon: "🤝",
        content: "Contributions are welcome! Please feel free to submit a Pull Request. For major changes, please open an issue first to discuss what you would like to change. Make sure to update tests and documentation as appropriate."
      },
      {
        title: "License",
        icon: "📄",
        content: "This project is licensed under the MIT License - see the LICENSE file for details. Feel free to use this code for your own projects."
      }
    ]
  }
}; 